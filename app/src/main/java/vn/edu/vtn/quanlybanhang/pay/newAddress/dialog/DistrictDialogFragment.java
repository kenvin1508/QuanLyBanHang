...
import vn.edu.vtn.quanlybanhang.apdater.pay.DistrictAdapter;
import vn.edu.vtn.quanlybanhang.data.model.address.District;

public class DistrictDialogFragment extends AppCompatDialogFragment {
    private ArrayList<District> list;
    public ArrayList<District> temp;
    ...
    DistrictDialogListener districtDialogListener;
...
//                recyclerView.setAdapter(new DistrictAdapter(getContext(), temp));
        ...
        districtAdapter.setOnItemClickListener(new DistrictAdapter.ClickListener() {
            @Override
            public void onItemClick(int position, View v) {
                District district = list.get(position);
                districtDialogListener.onFinishDistrictDialog(district.getTenQuanHuyen(), district.getMaQuanHuyen());
                dismiss();
            }
        });
    ...
    public interface DistrictDialogListener {
        void onFinishDistrictDialog(String districtName, String districtCode);
    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            districtDialogListener = (DistrictDialogListener) context;
